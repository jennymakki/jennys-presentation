    ...
    <>
      ...
      <div className="w-full max-w-5xl mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-8 text-white font-bold text-2xl">
          <Link href="/" className="hover:text-[#FF6F61] transition">HOME</Link>
          <Link href="/projects" className="hover:text-[#FF6F61] transition">PROJECTS</Link>
          <Link href="/about" className="hover:text-[#FF6F61] transition">ABOUT ME</Link>
        </nav>
      ...
      >
        <ul className="mt-32 p-6 text-2xl space-y-10 text-white font-bold">
          ...
          <li><Link href="/about" className="hover:text-blue-300">ABOUT ME</Link></li>
        </ul>
      </nav>
    </>
  );

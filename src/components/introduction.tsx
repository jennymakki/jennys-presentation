  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-6 pt-6">
      ...
      <div className="bg-[#EBEBEB] rounded-2xl md:ml-5 p-6 ml-10 mr-10 shadow-md max-w-md text-black">
        <p>
          Hi! I am Jenny, a full stack developer who loves building clean,
          user-friendly web apps. I enjoy working with both front-end and
          back-end tools to bring ideas to life.
        </p>
      </div>
    </div>
  );
